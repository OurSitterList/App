<?php
	...
	if(isset($_POST['bLogin']))
	{
		...
		if ($auth->login(
				DBPrefix."admin_login",
				$cond,
				array("id"=>"AID","updtime"=>"ALOG","adminid"=>"ANAME","atype"=>"ATYPE"),"updtime")
		)
		{
		...
		else
		{
			...
			$subuser = mysql_query("select * from `user_management` where user_name = '" . mysql_real_escape_string($_POST['uid']) . "' and user_password = '".mysql_real_escape_string(md5($_POST['pwd'])) . "'");
