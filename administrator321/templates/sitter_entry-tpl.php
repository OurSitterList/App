...
$result_row=mysql_fetch_object(mysql_query("SELECT * FROM `user_management` as UM JOIN user_information as UI where UM.user_id=UI.user_id  and UM.user_type='sitter' and UM.user_id=".$_GET['case_id']));
...
<div class="ad-notif-info grid_12"><p>Edit Sitter</p></div>
