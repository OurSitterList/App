...

{
					...
					if(is_uploaded_file($_FILES['user_image']['tmp_name'])){
						...
						$old_img = mysqli_fetch_object($search_query)->user_image;
...

					{
						...
						$user_image=mysqli_fetch_object($search_query)->user_image;
...
//echo $user_image; exit;
	...
	$update_query = "UPDATE user_information set
					...
					`user_newborn_cpr_training`= '".$user_newborn_cpr_training."',

					`user_food_allergies`= '".$user_food_allergies."',

					`user_overnight`= '".$user_overnight."',

					`user_travel`= '".$user_travel."',

					`user_permanent`= '".$user_permanent."',

					`user_newborn_exp`= '".$user_newborn_exp."',

					`user_sick_kids`= '".$user_sick_kids."',
					...
					`is_user_agree_to_houseplans`= '".$is_user_agree_to_houseplans."',

					`user_age`= '".$user_age."',

					`user_school_affliation`= '".$user_school_affliation."',
					...
					`user_available_mon_start`= '".$mon_s."',

					`user_available_tue_start`= '".$tue_s."',

					`user_available_wed_start`= '".$wed_s."',

					`user_available_thu_start`= '".$thu_s."',

					`user_available_fri_start`= '".$fri_s."',

					`user_available_sat_start`= '".$sat_s."',

					`user_available_sun_start`= '".$sun_s."',

					`user_available_mon_end`= '".$mon_e."',

					`user_available_tue_end`= '".$tue_e."',

					`user_available_wed_end`= '".$wed_e."',

					`user_available_thu_end`= '".$thu_e."',

					`user_available_fri_end`= '".$fri_e."',

					`user_available_sat_end`= '".$sat_e."',

					`user_available_sun_end`= '".$sun_e."',

					`user_babysitting_exp`= '".$user_babysitting_exp."'
...
$sql = "select i.*, m.user_email from  user_information i LEFT JOIN user_management m ON m.user_id = i.user_id where i.user_id='".$_SESSION['user_id']."'";
...

{
	...
	$R = mysqli_fetch_assoc($search_query);
          ...
          <div class="left_form">
            ...
            <div class="input_outer">
              ...
              <div class="input_area bluetext" style="white-space: nowrap;">
                ...
                <input type="button" value="Change Email" class="login_sub_btn" onclick="document.location='change_email.php?from=sitter';" />
                ...
                <select class="input_lrg" name="location_code" id="location_code"  >
                  ...
                  <?php  $state_query =  mysql_query("select * from states order by state ");
...

						{
							...
							//while($S = mysqli_fetch_object($state_query))
