        ...
        <?php  if(isset($_POST['sitter_loginForm']) && $_POST['sitter_loginForm']=='yes')

		  {
			  ...
			  $sql	= "select * from user_management where 
			  			...
			  			user_name='".escapeString($user_name)."'

						AND user_password='".escapeString(md5($user_password))."'
              ...
              //die('USER: ' . $_POST['user_name'] . ' / ' . escapeString($user_name));
              //print_r($_POST);
              //die('LOGIN CHECK: ' . mysql_num_rows($user_search));
...
header('Location:'.$base_path.'/family_dashboard.php');
	...
	$admin_contact_name = mysql_fetch_array(mysql_query("SELECT `settingValue` FROM `setting` WHERE `id`='4'"));
		  ...
		  ?>
            ...
            <form action="action.php?do" id="sitter_loginForm" method="post">
            ...
            <form action="action.php?" id="sitter_loginForm" method="post">
