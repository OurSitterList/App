...
<div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="sitter_details_one">
                <div class="sitter_pic"> <a href="<?=$base_path?>/family_details.php?family_user_id=<?=base64_encode($reviews->family_user_id)?>"><img src="<?=$base_path?>/images/user_images/<?=$reviews->user_image?>" alt="" /></a> </div>
              </div>
            </div>
        ...
        <?php
				  ...
				  echo "<p>No review at this moment.</p>";
			  }
		?>
