...
//				  $mail->setFrom($admin_contact_email['settingValue'], $admin_contact_name['settingValue']);
		  ...
		  ?>
            <div class="md-modal md-effect-16" id="modal-16">
                ...
                <div id="loginLoader" style="display: none">Please wait while we sign you in... <br /><br /><img src="/images/ajax-loader-blue.gif" /></div>
                <div class="md-content" id="loginWindowContent">
                    <div class="sitter_log">
                        ...
                        <div class="sitter_form"  id="sitter_login_form" >
                            <form action="action.php?do<?php if (isset($_REQUEST['redirect']) && $_REQUEST['redirect']) echo "&redirect=" . urlencode($_REQUEST['redirect']); ?>" id="sitter_loginForm" method="post">
                              ...
                              <div id="sitter_login_buttons">
                                ...
                                <div id="sitter_login_loader" style="display: none; color: #005982;"><img src="/images/ajax-loader-blue.gif" /> Signing in...</div>
                            </form>
                        </div>
                    ...
                    <div class="family_log">
                        ...
                        <form action="action.php?<?php if (isset($_REQUEST['redirect']) && $_REQUEST['redirect']) echo "redirect=" . urlencode($_REQUEST['redirect']); ?>"" id="sitter_loginForm" method="post">
                          ...
                          <div id="family_login_buttons">
                            ...
                            <div id="family_login_loader" style="display: none; color: #005982;"><img src="/images/ajax-loader-blue.gif" /> Signing in...</div>
                        </form>
                        </div>
            ...
            {
                ?>
            <option value="<?=$S->state_code?>" <?=$S->state_code==$loc?'selected':''?> >
            <?=$S->state?>
            </option>
            <?php
            }
