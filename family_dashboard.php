            ...
            <div class="sitter_detail_inner">
                ...
                if (count($query) > 0) {
                    ...
                    <div class="smartmarquee hscroller">
                        <ul class="container">
                            <?php foreach ($query as $top_rated) {
                                if ($top_rated->name != "") {
                                    ?>
                                    <li>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        <div class="sitter_details_one">
                                                            <div class="sitter_pic" style="text-align: center;"><a
                                                                        href="<?= $base_path ?>/sitter_details.php?sitter_id=<?= base64_encode($top_rated->user_id) ?>"><img
                                                                            src="<?= $base_path ?>/images/<?= (($top_rated->user_image) ? 'user_images/' . $top_rated->user_image . '"' : 'person-blue-icon-96.png" style="padding-top: 40px; width: auto; height: auto"'); ?> alt=""
                                                                    /></a></div>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div class="top-pad">
                                                                        <?php if ($R->cpr_approve == 1) {
                                                                            ...
                                                                            <div class="sitter_personal_detl sitter_certified">
                                                                                <h3><span style="font-family: Arial Unicode MS, Lucida Grande">&#10004;</span>Cpr
                                                                                    Certified</h3>
                                                                            </div>
                                                                            <?php
                                                                        }
                                                                        ...
                                                                        <?php if ($R->newborn_approve == 1) {
                                                                            ?>
                                                                            <div class="sitter_personal_detl sitter_certified">
                                                                                <h3><span style="font-family: Arial Unicode MS, Lucida Grande">&#10004;</span>
                                                                                    Reference Checked</h3>
                                                                            </div>
                                                                            <?php
                                                                        }
                                                                        ?>
                ...
                $search_query = $db->get($search_query_sql);
                if (count($search_query) > 0) {
                    ...
                    foreach ($search_query as $R) {
                        ...
                        /*$search_booking_date = $db->get("select * from book_management
                                        where sitter_user_id=:user_id 
                                        and sitter_approval!='2' 
                                        and `booking_date` 
                                        between '" . $_REQUEST['search_from_date'] . "' 
                                        and '" . $_REQUEST['search_to_date'] . "' ", [
                                                'user_id' => $R->user_id,
                                        ]);*/
                        ?>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="sitter_details_one" style="text-align: center">
                                                <div class="sitter_pic"><img
                                                            src="<?= $base_path ?>/images/<?= (($R->user_image) ? 'user_images/' . $R->user_image . '"' : 'person-blue-icon-96.png" style="padding-top: 40px; width: auto; height: auto"'); ?> alt=""
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <?=$R->user_biography?>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="top-pad">
                                                            ...
                                                            <div class="sitter_personal_detl sitter_certified">
                                                                <h3>
                                                                    <p><span style="font-family: Arial Unicode MS, Lucida Grande">&#10004;</span>
                                                                        Background Check</p>
                                                                </h3>
                                                            </div>
                                                        </div>
